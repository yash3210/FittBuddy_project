package com.example.fit_buddy.CALCULATOR.KG;
...
public class Kids_Growth extends Activity {
...
//    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_kids_growth);
...
//        this.tv_select_age.setTypeface(this.typefaceManager.getBold());
        ...
        this.iv_back.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Kids_Growth.this.onBackPressed();
            }
        });
        ...
        this.tv_search_child_height.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                try {
                    Kids_Growth.this.months = Integer.parseInt(Kids_Growth.this.tv_childmonth.getText().toString().trim().replace(Kids_Growth.this.getString(R.string.Month), ""));
                    Kids_Growth.this.calculate(Kids_Growth.this.months);
                    String[] split = Kids_Growth.this.calculate(Kids_Growth.this.months).split("~");
                    StringBuilder sb = new StringBuilder();
                    sb.append("Height");
                    sb.append(split[0]);
                    Log.d("Height", sb.toString());
                    Kids_Growth child_Growth_Calculator = Kids_Growth.this;
                    StringBuilder sb2 = new StringBuilder();
                    sb2.append(Kids_Growth.this.getString(R.string.Estimated_Height));
                    sb2.append(" : \n");
                    sb2.append(split[0]);
...
//                    if (random == 2) {
//                        Kids_Growth.this.showIntertitial();
//                        return;
//                    }
                    Intent intent = new Intent(Kids_Growth.this, Child_growth_result.class);
                    StringBuilder sb4 = new StringBuilder();
                    sb4.append(Kids_Growth.this.getString(R.string.Estimated_Height));
                    sb4.append(" : \n");
                    sb4.append(split[0]);
                    intent.putExtra("result", sb4.toString());
                    intent.putExtra("age", String.valueOf(Kids_Growth.this.months));
                    Kids_Growth.this.startActivity(intent);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        });
        this.tv_search_child_weight.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Kids_Growth.this.months = Integer.parseInt(Kids_Growth.this.tv_childmonth.getText().toString().trim().replace(Kids_Growth.this.getString(R.string.Month), ""));
                Kids_Growth.this.calculate(Kids_Growth.this.months);
                String[] split = Kids_Growth.this.calculate(Kids_Growth.this.months).split("~");
                Kids_Growth child_Growth_Calculator = Kids_Growth.this;
                StringBuilder sb = new StringBuilder();
                sb.append(Kids_Growth.this.getString(R.string.Estimated_Weight));
                sb.append(" : \n");
                sb.append(split[1]);
...
//                }
                Intent intent = new Intent(Kids_Growth.this, Child_growth_result.class);
                StringBuilder sb3 = new StringBuilder();
                sb3.append(Kids_Growth.this.getString(R.string.Estimated_Weight));
                sb3.append(" : \n");
                sb3.append(split[1]);
        ...
        this.tv_search_headcircumference.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                try {
                    Kids_Growth.this.months = Integer.parseInt(Kids_Growth.this.tv_childmonth.getText().toString().trim().replace(Kids_Growth.this.getString(R.string.Month), ""));
                    Kids_Growth.this.calculate(Kids_Growth.this.months);
                    ...
                    Kids_Growth child_Growth_Calculator = Kids_Growth.this;
                    StringBuilder sb = new StringBuilder();
                    sb.append(Kids_Growth.this.getString(R.string.Estimated_Head_Circumference));
                    sb.append(" : \n");
                    sb.append(split[2]);
                    child_Growth_Calculator.putext_val = sb.toString();
                    int random = ((int) (Math.random() * 2.0d)) + 1;
...
//                    }
                    Intent intent = new Intent(Kids_Growth.this, Child_growth_result.class);
                    StringBuilder sb3 = new StringBuilder();
                    sb3.append(Kids_Growth.this.getString(R.string.Estimated_Head_Circumference));
                    sb3.append(" : \n");
                    sb3.append(split[2]);
                    intent.putExtra("result", sb3.toString());
                    intent.putExtra("age", String.valueOf(Kids_Growth.this.months));
    ...
    private View.OnClickListener showPopupWindow_month() {
        return new View.OnClickListener() {
            public void onClick(View view) {
                Kids_Growth.this.popupWindowmonth().showAsDropDown(view, 0, 0);
            }
        };
    }
    ...
    public PopupWindow popupWindowmonth() {
        ...
        this.listViewmonth.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                ...
                sb2.append((String) Kids_Growth.this.arraylist_month.get(i));
                Log.d("arraylist_weigth", sb2.toString());
                Kids_Growth.this.tv_childmonth.setText((CharSequence) Kids_Growth.this.arraylist_month.get(i));
                Kids_Growth.this.dismissPopupTopics();
            }
        });
