package com.example.fit_buddy.CALCULATOR.DCI;
...
public class Daily_Calories_Intake extends Activity {
    Double BMR;
...
//    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_daily_calories_intake);
...
//        mAdView.loadAd(adRequest);
        ...
        this.iv_back.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Daily_Calories_Intake.this.onBackPressed();
            }
        });
        this.rg_activity_level.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RadioButton radioButton = (RadioButton) Daily_Calories_Intake.this.findViewById(i);
                Daily_Calories_Intake.this.activity_level = String.valueOf(radioButton.getText());
            }
        });
        this.tv_search_calories_intake.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (Daily_Calories_Intake.this.et_age.getText().toString().trim().equals("")) {
                    Daily_Calories_Intake.this.et_age.setError("Enter Age");
                } else if (Daily_Calories_Intake.this.et_height.getText().toString().trim().equals("") || Daily_Calories_Intake.this.et_height.getText().toString().trim().equals(".")) {
                    Daily_Calories_Intake.this.et_height.setError("Enter Height");
                } else if (Daily_Calories_Intake.this.et_weight.getText().toString().trim().equals("") || Daily_Calories_Intake.this.et_weight.getText().toString().trim().equals(".")) {
                    Daily_Calories_Intake.this.et_weight.setError("Enter Weight");
                } else if (Daily_Calories_Intake.this.activity_level.equals("")) {
                    Toast.makeText(Daily_Calories_Intake.this.getApplicationContext(), "Select Activity Level", 0).show();
                } else {
                    Daily_Calories_Intake.this.height_unit = Daily_Calories_Intake.this.tv_heightunit.getText().toString().trim();
                    Daily_Calories_Intake.this.weight_unit = Daily_Calories_Intake.this.tv_weightunit.getText().toString().trim();
                    if (!Daily_Calories_Intake.this.et_height.getText().toString().equals(".")) {
                        Daily_Calories_Intake.this.inserted_height = Float.valueOf(Float.parseFloat(Daily_Calories_Intake.this.et_height.getText().toString().trim()));
                    }
                    if (!Daily_Calories_Intake.this.et_weight.getText().toString().equals(".")) {
                        Daily_Calories_Intake.this.inserted_weight = Float.valueOf(Float.parseFloat(Daily_Calories_Intake.this.et_weight.getText().toString().trim()));
                    }
                    Daily_Calories_Intake.this.age = Integer.parseInt(Daily_Calories_Intake.this.et_age.getText().toString());
                    Daily_Calories_Intake.this.gender = Daily_Calories_Intake.this.tv_gender.getText().toString().trim();
                    ...
                    printStream.println(sb.toString());
                        Daily_Calories_Intake.this.calculate();
                }
            }
        });
    }
    ...
    private View.OnClickListener showPopupWindowHeight() {
        return new View.OnClickListener() {
            public void onClick(View view) {
                Daily_Calories_Intake.this.popupWindowHeight().showAsDropDown(view, 0, 0);
            }
        };
    }
    ...
    public PopupWindow popupWindowHeight() {
        ...
        this.listViewHeight.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                ...
                sb2.append((String) Daily_Calories_Intake.this.arraylist_height.get(i));
                Log.d("arraylist_height", sb2.toString());
                Daily_Calories_Intake.this.tv_heightunit.setText((CharSequence) Daily_Calories_Intake.this.arraylist_height.get(i));
                Daily_Calories_Intake.this.dismissPopupHeight();
            }
        });
    ...
    private View.OnClickListener showPopupWindow_Weight() {
        return new View.OnClickListener() {
            public void onClick(View view) {
                Daily_Calories_Intake.this.popupWindowWeight().showAsDropDown(view, 0, 0);
            }
        };
    }
    ...
    public PopupWindow popupWindowWeight() {
        ...
        this.listViewWeight.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                Daily_Calories_Intake.this.tv_weightunit.setText((CharSequence) Daily_Calories_Intake.this.arraylist_weigth.get(i));
                Daily_Calories_Intake.this.dismissPopupTopics();
            }
        });
    ...
    private View.OnClickListener showPopupWindow_gender() {
        return new View.OnClickListener() {
            public void onClick(View view) {
                Daily_Calories_Intake.this.popupWindowgender().showAsDropDown(view, 0, 0);
            }
        };
    }
    ...
    public PopupWindow popupWindowgender() {
        ...
        this.listViewgender.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                Daily_Calories_Intake.this.tv_gender.setText((CharSequence) Daily_Calories_Intake.this.arraylist_gender.get(i));
                Daily_Calories_Intake.this.dismissPopupgender();
            }
        });
