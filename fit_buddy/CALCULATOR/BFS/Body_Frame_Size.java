package com.example.fit_buddy.CALCULATOR.BFS;
...
public class Body_Frame_Size extends Activity {
...
//        this.tv_gender.setTypeface(this.typefaceManager.getLight());
        ...
        this.tv_search_bmi.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (Body_Frame_Size.this.et_height.getText().toString().trim().equals("") || Body_Frame_Size.this.et_height.getText().toString().trim().equals(".")) {
                    Body_Frame_Size.this.et_height.setError(Body_Frame_Size.this.getString(R.string.Enter_Height));
                } else if (Body_Frame_Size.this.et_weight.getText().toString().trim().equals("") || Body_Frame_Size.this.et_weight.getText().toString().trim().equals(".")) {
                    Body_Frame_Size.this.et_weight.setError(Body_Frame_Size.this.getString(R.string.Enter_Weight));
                } else {
                    Body_Frame_Size.this.height_unit = Body_Frame_Size.this.tv_heightunit.getText().toString();
                    Body_Frame_Size.this.weight_unit = Body_Frame_Size.this.tv_weightunit.getText().toString();
                    Body_Frame_Size.this.inserted_weight = Float.parseFloat(Body_Frame_Size.this.et_weight.getText().toString());
                    Body_Frame_Size.this.inserted_height = Float.parseFloat(Body_Frame_Size.this.et_height.getText().toString());
                    StringBuilder sb = new StringBuilder();
                    sb.append("inserted_weight");
                    sb.append(Body_Frame_Size.this.inserted_weight);
                    Log.d("inserted_weight", sb.toString());
                    StringBuilder sb2 = new StringBuilder();
                    sb2.append("inserted_height");
                    sb2.append(Body_Frame_Size.this.inserted_height);
                    ...
                    printStream.println(sb3.toString());
                        ...
                        Body_Frame_Size.this.calculate();
        ...
        this.iv_back.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Body_Frame_Size.this.onBackPressed();
            }
        });
    }
    ...
    private View.OnClickListener showPopupWindowHeight(final boolean z) {
        return new View.OnClickListener() {
            public void onClick(View view) {
                Body_Frame_Size.this.popupWindowHeight(z).showAsDropDown(view, 0, 0);
            }
        };
    }
    ...
    public PopupWindow popupWindowHeight(final boolean z) {
        ...
        this.listViewHeight.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                if (z) {
                    Body_Frame_Size.this.tv_heightunit.setText((CharSequence) Body_Frame_Size.this.arraylist_height.get(i));
                } else {
                    Body_Frame_Size.this.tv_weightunit.setText((CharSequence) Body_Frame_Size.this.arraylist_wrist.get(i));
                }
                Body_Frame_Size.this.popupWindowHeight.dismiss();
            }
        });
    ...
    private View.OnClickListener showPopupWindowGender() {
        return new View.OnClickListener() {
            public void onClick(View view) {
                Body_Frame_Size.this.popupWindowGender().showAsDropDown(view, 0, 0);
            }
        };
    }
    ...
    public PopupWindow popupWindowGender() {
        ...
        this.listViewGender.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                Body_Frame_Size.this.tv_gender.setText((CharSequence) Body_Frame_Size.this.arraylist_gender.get(i));
                Body_Frame_Size.this.tv_genderunit.setText((CharSequence) Body_Frame_Size.this.arraylist_gender.get(i));
                Body_Frame_Size.this.dismissPopupGender();
            }
        });
