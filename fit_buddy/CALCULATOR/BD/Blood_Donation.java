package com.example.fit_buddy.CALCULATOR.BD;
...
import com.example.fit_buddy.calendar.DateUtil;
import com.example.fit_buddy.calendar.SNPCalendarView;
import com.example.fit_buddy.calendar.onSNPCalendarViewListener;
...
//        this.tv_search_date.setTypeface(this.typefaceManager.getBold());
        ...
        this.iv_back.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Blood_Donation.this.onBackPressed();
            }
        });
...
//                if (random == 2) {
//                    Blood_Donation.this.showIntertitial();
//                    return;
//                }
                Intent intent = new Intent(Blood_Donation.this, Blood_Donation_Result.class);
                intent.putExtra("prevdate", Blood_Donation.this.prev_date);
                intent.putExtra("nextdate", Blood_Donation.this.eligieble_date);
                intent.putExtra("flag", "0");
                Blood_Donation.this.startActivity(intent);
            }
        });
        this.mFCalendarView.setOnCalendarViewListener(new onSNPCalendarViewListener() {
            ...
            public void onDateChanged(String str) {
                ...
                try {
                    ...
                    Blood_Donation.this.get_eligieble_date(str);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
