...
//        mAdView.loadAd(adRequest);
        ...
        this.tv_search_heart_rate.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (Heart_Rate.this.et_age.getText().toString().trim().equals("")) {
                    Heart_Rate.this.et_age.setError(Heart_Rate.this.getString(R.string.Enter_Age));
                } else if (Heart_Rate.this.et_heart_rate.getText().toString().trim().equals("")) {
                    Heart_Rate.this.et_heart_rate.setError(Heart_Rate.this.getString(R.string.Enter_Heart_Rate));
                } else {
                    Heart_Rate.age = Integer.parseInt(Heart_Rate.this.et_age.getText().toString().trim());
                    Heart_Rate.avg_resting_rate = Integer.parseInt(Heart_Rate.this.et_heart_rate.getText().toString().trim());
