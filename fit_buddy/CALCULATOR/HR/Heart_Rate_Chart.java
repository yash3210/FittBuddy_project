package com.example.fit_buddy.CALCULATOR.HR;
...
//        }
        ...
        this.tv_hr1.setText(String.valueOf((int) Heart_Rate.lower_rate1));
        this.tv_hr2.setText(String.valueOf((int) Heart_Rate.lower_rate2));
        this.tv_hr3.setText(String.valueOf((int) Heart_Rate.lower_rate3));
        this.tv_hr4.setText(String.valueOf((int) Heart_Rate.lower_rate4));
        this.tv_hr5.setText(String.valueOf((int) Heart_Rate.lower_rate5));
        this.tv_hr6.setText(String.valueOf((int) Heart_Rate.lower_rate6));
        this.tv_hr7.setText(String.valueOf((int) Heart_Rate.lower_rate7));
        this.tv_hr8.setText(String.valueOf((int) Heart_Rate.lower_rate8));
        this.tv_hr9.setText(String.valueOf((int) Heart_Rate.lower_rate9));
        this.tv_hr10.setText(String.valueOf((int) Heart_Rate.lower_rate10));
        this.tv_targethr1.setText(String.valueOf((int) Heart_Rate.target_heart_rate50));
        this.tv_targethr2.setText(String.valueOf((int) Heart_Rate.target_heart_rate55));
        this.tv_targethr3.setText(String.valueOf((int) Heart_Rate.target_heart_rate60));
        this.tv_targethr4.setText(String.valueOf((int) Heart_Rate.target_heart_rate65));
        this.tv_targethr5.setText(String.valueOf((int) Heart_Rate.target_heart_rate70));
        this.tv_targethr6.setText(String.valueOf((int) Heart_Rate.target_heart_rate75));
        this.tv_targethr7.setText(String.valueOf((int) Heart_Rate.target_heart_rate80));
        this.tv_targethr8.setText(String.valueOf((int) Heart_Rate.target_heart_rate85));
        this.tv_targethr9.setText(String.valueOf((int) Heart_Rate.target_heart_rate90));
        this.tv_targethr10.setText(String.valueOf((int) Heart_Rate.target_heart_rate95));
    }
